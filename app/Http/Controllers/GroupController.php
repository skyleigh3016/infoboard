...
class GroupController extends Controller  
{
    ...
    public function create(Request $request)
    {
       ...
       $group->participants()->attach(auth()->user()->id);
        ...
        return redirect('/group')->with('success', 'Your group has been created');
    }
       ...
       $group = Group::where('code', $code)->first();
        ...
        if ($group)
        {
            try 
            {
                ...
                $group->participants()->attach(auth()->user()->id);
                return redirect('/group')->with('success', 'Group joined');
            } 
            catch (\Throwable $th) 
            {
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/group')->with('success', 'Group name has been changed');
    }
