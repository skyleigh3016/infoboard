    ...
    <div class="table-wrapper">
      <div class="table-title">
          <div class="row">
            <div class="col-sm-6">
              <span>
                <a href="{{ route('users.index') }}" class="fa fa-arrow-left" aria-hidden="true"></a>
              </span>
              <h2 style = >Archived <b>Users</b></h2>
            </div>
          </div>
      </div>
        ...
        <tbody>
          @foreach($users as $user)
            <tr>
              ...
              <td class = "image">
                <img src="{{ asset('images/users') . '/' . $user->user_image }}" class="img img-responsive" style="hight:120px; width:120px;">
              </td>

              <td class="d-flex justify-content-center">

                <div>
                  <a href="{{route('user.restore',['id'=>$user->id] ) }}" class="btn btn-success btn-sm"
                target="blank">
