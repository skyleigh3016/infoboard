    ...
    <div class="table-wrapper">
      <div class="table-title">
        <div class="row">
          <div class="col-sm-6">
            <span>
              <a href="{{ route('admin.index') }}" class="fa fa-arrow-left" aria-hidden="true"></a>
            </span>
            <h2 style = >Archived <b>Admins</b></h2>
          </div>
        </div>
      </div>
          ...
          @foreach($admins as $admin)
            <tr>
              ...
              <td class="d-flex justify-content-center">
                <div>
                  <a href="{{route('admin.restore',['id'=>$admin->id] ) }}" class="btn btn-success btn-sm  "
                  target="blank">
