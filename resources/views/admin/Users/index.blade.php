        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <a href="{{route('user.trash')}}" class="btn btn-primary btn-sm">
                ...
                <tbody>
                    @foreach($users as $user)
                        <tr>
                            ...
                            <td class = "image">
                                <img src="{{ asset('images/users') . '/' . $user->user_image }}" class="img img-responsive" style="height:120px; width:120px;">
                            </td>
            
                            <td class="d-flex justify-content-center">

                                <a href="{{url('user/edit/'.$user->id)}}" class="btn btn-primary mr-1 px-1 py-0 ">
                                    <i class="bi bi-pencil-square"  data-toggle="tooltip"></i></a>

                                <form action="{{route('user.archive',['id'=>$user->id] ) }}">
