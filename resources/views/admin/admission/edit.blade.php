...
@endif
	<div class="card-body">
  <form action="{{route('update.learning')}}" method="POST" enctype="multipart/form-data">
          @csrf 

          <input type="hidden" value="{{$learnings->id}}" name="id">

			<div class="row mb-3">
				<label class="col-sm-2 col-label-form">Title</label>
				<div class="col-sm-10">
					<input type="text" name="title" value="{{ $learnings-> title }}" class="form-control">
				</div>
			</div>
        ...
        <script>
			...
			<div class="row mb-4">
					...
					<div class="col-sm-10">
          <input type="file" name="video" value="{{ $learnings->video }}" />
      <video class="" style="height:500px; width:720px;">
      <source src="{{asset($learnings->video)}}" alt="Announcement image"  type="video/mp4"><video>
