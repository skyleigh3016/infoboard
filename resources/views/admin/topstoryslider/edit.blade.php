...
<div class="card">
	...
	<div class="card-header">
        <a href="{{ route('topstoryslider.index') }}"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>
	...
	<div class="card-body">
		<form method="post" action="{{route('update.story')}}" enctype="multipart/form-data">
			...
			<div class="row mb-3">
				...
				<div class="col-sm-10">
					<input type="text" name="title" value="{{ $stories-> title }}" class="form-control">
				</div>
			</div>
        ...
        <script>
			...
			<div class="row mb-4">
					...
					<div class="col-sm-10">
						<input type="file" name="image" value="{{ $stories->image }}" />
                        <img src="/images/{{ $stories->image }}" class="img img-responsive" style="height:120px; width:120px;">
					</div>
			</div>
