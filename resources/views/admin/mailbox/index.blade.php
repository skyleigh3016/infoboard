...
<tr>
    ...
    <td class = "message">{{Carbon\Carbon::parse($contact->created_at)->diffForHumans()}}</td>
    ...
    <button type="submit" class="btn btn-danger delete px-1 py-0"><i class="bi bi-trash"></i></button>
    </form>
