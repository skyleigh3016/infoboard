        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row" style="display: inline-block;" >
                        <span>
                            <a href="{{ route('home.announcement') }}" class="fa fa-arrow-left" aria-hidden="true"></a>
                        </span>
                        <span>
                            <h2 style = >Archived <b>Announcements</b></h2>  
                        </span>
                        ...
                        @foreach($announcements as $announcement)
                            <tr>
                                ...
                                <td class="d-flex justify-content-center">
                                    <div>
                                       <a href="{{route('announcement.restore',['id'=>$announcement->id] ) }}" class="btn btn-success btn-sm  "
                                        target="blank"><i class="material-icons"style="color: rgb(0, 0, 0);font-size: 27px;">unarchive</i></a>
                                    </div>
                                    <div>
                                        <!-- noticecontroller the logic to delete -->
                                      <form action="{{route('announcement.delete', $announcement->id)}}" method="GET">
                                        @csrf
