...
<div class="py-12"> 
  ...
  <label for="exampleInputEmail1">Announcement</label>
     ...
     <div class="form-group">
    <input type="file" name="image" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $announcements->image}}">
    <!-- <img src="{{ asset('images/users') . '/' . $announcements->image }}" style="width:500px; height:300px;" > -->
  </div>

     <div class="form-group"><img src="{{asset($announcements->image)}}" style="width:400px; height:400px;" >
     </div>
