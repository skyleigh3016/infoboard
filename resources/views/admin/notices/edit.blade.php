...
<div class="card">
	...
	<div class="card-header">
        <a href="{{ route('home.announcement') }}"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>
...
@endif
	<div class="card-body">
		<form method="post" action="{{route('update.announcement')}}" enctype="multipart/form-data">
			@csrf
			...
			<div class="row mb-3">
				...
				<div class="col-sm-10">
					<input type="text" name="title" value="{{ $announcements-> title }}" class="form-control">
				</div>
			</div>
        ...
        <script>
			...
			<div class="row mb-4">
					...
					<div class="col-sm-10">
						<input type="file" name="image" value="{{ $announcements->image }}" />
                        <img src="{{asset($announcements->image)}}" class="img img-responsive" style="height:120px; width:120px;">
					</div>
			</div>
